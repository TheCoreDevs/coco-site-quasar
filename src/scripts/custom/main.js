...
/*
	...
	Outputs: []
*/
export async function mint1 (pair, cost) {
	...
	return await signedContract.mint1(tx)
}
...
/*
	...
	Outputs: []
*/
export async function mint2 (pair, cost) {
	const provider = getState().provider
	const signer = await provider.getSigner()
	const address = await signer.getAddress()
	const signedContract = pair.contract.connect(signer)
	...
	return await signedContract.mint2(tx)
}
...
/*
	...
	Outputs: []
*/
export async function preMint1 (pair, sig, cost) {
	const provider = getState().provider
	const signer = await provider.getSigner()
	const address = await signer.getAddress()
	const signedContract = pair.contract.connect(signer)
	...
	return await signedContract.preMint1(sig, tx)
}
...
/*
	...
	Outputs: []
*/
export async function preMint2 (pair, sig, cost) {
	const provider = getState().provider
	const signer = await provider.getSigner()
	const address = await signer.getAddress()
	const signedContract = pair.contract.connect(signer)
	...
	return await signedContract.preMint2(sig, tx)
}
